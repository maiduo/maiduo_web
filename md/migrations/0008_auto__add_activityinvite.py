...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActivityInvite'
        db.create_table('md_activityinvite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['md.Activity'])),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('avaiable', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('create_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('md', ['ActivityInvite'])


    def backwards(self, orm):
        # Deleting model 'ActivityInvite'
        db.delete_table('md_activityinvite')
