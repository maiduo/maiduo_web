...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('md_usertoken', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=6)),
        ...
        db.send_create_signal('md', ['UserToken'])

        # Adding model 'SMSLog'
        db.create_table('md_smslog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('mobile', self.gf('django.db.models.fields.TextField')()),
            ('ip', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39)),
            ('create_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('md', ['SMSLog'])

        # Adding field 'Message.stash'
        db.add_column('md_message', 'stash',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('md_usertoken')

        # Deleting model 'SMSLog'
        db.delete_table('md_smslog')

        # Deleting field 'Message.stash'
        db.delete_column('md_message', 'stash')
