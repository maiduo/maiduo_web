...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ActivityInvite.username'
        db.delete_column('md_activityinvite', 'username')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ActivityInvite.username'
        raise RuntimeError("Cannot reverse this migration. 'ActivityInvite.username' and its values cannot be restored.")
        # Deleting field 'ActivityInvite.user'
        db.delete_column('md_activityinvite', 'user_id')

        # Deleting field 'ActivityInvite.refer'
        db.delete_column('md_activityinvite', 'refer_id')
    ...
    models = {
        ...
        'md.activity': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': "orm['auth.User']"}),
            'subject': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'update_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'participate'", 'symmetrical': 'False', 'to': "orm['auth.User']"})
        },
        'md.activityinvite': {
            'Meta': {'object_name': 'ActivityInvite'},
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['md.Activity']"}),
            'avaiable': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'create_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'refer': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'related_name': "'refers'", 'to': "orm['auth.User']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'related_name': "'users'", 'to': "orm['auth.User']"})
        },
        'md.chat': {
        ...
        'md.messageaddon': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['md.Message']"})
        }
    }
