...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MessageAddon.create_at'
        db.add_column(u'md_messageaddon', 'create_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 1, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MessageAddon.create_at'
        db.delete_column(u'md_messageaddon', 'create_at')
    ...
    models = {
        ...
        u'md.messageaddon': {
            ...
            'create_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 1, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
