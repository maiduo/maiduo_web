...
MEDIA_ROOT = os.getenv('HIMAIDUO_MEDIA_ROOT', os.path.join(WEB_ROOT, "media"))
...
SECRET_KEY = '!r=slv2u4wz@0h(lm0poqfehqgr-t9!^prbd65s#+@bgtem&amp;$1'
...
ROOT_URLCONF = 'mdapp.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'mdapp.wsgi.application'
